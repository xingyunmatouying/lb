...
class TestLeaderboardRow(unittest.TestCase):
  ...
  def test_from_psv(self) -> None:
    leaderboard_row = LeaderboardRow.from_psv("Bot1||1500|100|2024-04-01|2025-04-01|4|1|50|3|1600|False")
  ...
  def test_to_psv(self) -> None:
    perf = LeaderboardPerf("Bot1", "EU", 1500, 100, "2024-04-01", "2025-04-01")
    leaderboard_row = LeaderboardRow(perf, 4, 1, 50, 3, 1600, True)
    expected_psv = "Bot1|EU|1500|100|2024-04-01|2025-04-01|4|1|50|3|1600|True"
