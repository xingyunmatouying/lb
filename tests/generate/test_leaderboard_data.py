...
TOP_BOT_PERF = LeaderboardPerf("Top Bot", "", 1800, 0, 0, 400, "2021-04-01", "2025-10-12")
FIRST_MIDDLE_BOT_PERF = LeaderboardPerf("First Middle Bot", "", 1500, 0, 0, 100, "2022-04-01", "2025-10-12")
SECOND_MIDDLE_BOT_PERF = LeaderboardPerf("Second Middle Bot", "", 1500, 0, 0, 200, "2023-04-01", "2025-10-12")
BOTTOM_BOT_PERF = LeaderboardPerf("Bottom Bot", "", 1200, 0, 0, 300, "2025-04-01", "2025-10-12")
...
class TestLeaderboardPerf(unittest.TestCase):
  ...
  def test_from_bot_user(self) -> None:
    ...
    self.assertEqual(leaderboard_perf, LeaderboardPerf("Bot1", "", 1450, 0, 0, 100, "2024-01-01", "2025-04-01"))
...
class TestLeaderboardRow(unittest.TestCase):
  ...
  def test_from_psv(self) -> None:
    leaderboard_row = LeaderboardRow.from_psv("Bot1||1500|12|34|100|2024-04-01|2025-04-01|4|1|50|3|1600|False")
    expected_perf = LeaderboardPerf("Bot1", "", 1500, 12, 34, 100, "2024-04-01", "2025-04-01")
  ...
  def test_to_psv(self) -> None:
    perf = LeaderboardPerf("Bot1", "EU", 1500, 12, 34, 100, "2024-04-01", "2025-04-01")
    leaderboard_row = LeaderboardRow(perf, 4, 1, 50, 3, 1600, True)
    expected_psv = "Bot1|EU|1500|12|34|100|2024-04-01|2025-04-01|4|1|50|3|1600|True"
...
class TestLeaderboardUpdate(unittest.TestCase):
  ...
  def test_row_only_update(self) -> None:
    previous_perf = LeaderboardPerf("Bot 1", "", 1500, 0, 0, 100, "2024-01-01", "2025-01-01")
  ...
  def test_full_update(self) -> None:
    previous_perf = LeaderboardPerf("Bot 1", "", 1500, 0, 0, 100, "2024-01-01", "2025-01-01")
    previous_row = LeaderboardRow(previous_perf, 5, 0, 0, 3, 1500, True)
    current_perf = LeaderboardPerf("Bot 1", "", 1600, 0, 0, 120, "2024-01-01", "2024-01-02")
